...
export function Sidebar({
  ...
  return (
    <>
      ...
      <aside
        className={`w-full lg:w-72 lg:fixed lg:inset-y-0 lg:left-0 bg-[#0f1115] border-r border-border/40 overflow-y-auto z-20 shadow-xl transition-all duration-300 ease-in-out ${
      ...
      >
        <div className="p-8 space-y-10">
          ...
          <div className="space-y-2">
            <h3 className="text-[10px] font-bold text-muted uppercase tracking-widest px-1 mb-2">
              Navigation
            </h3>
            ...
            <div className="flex flex-col gap-2">
              {STRATEGY_FILTERS.map((filter) => (
                <button
                  ...
                  className={`flex items-center justify-between px-4 py-3 rounded-xl text-xs font-bold transition-all border group ${
                    strategyFilter === filter.label
